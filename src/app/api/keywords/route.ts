...
interface BrandDef { name: string; keywords: string[] }
interface GroupDef { label: string; brands: BrandDef[] }
...
const DEFAULT_GROUPS: Groups = {
  folder_mat: {
    label: "폴더매트",
    brands: [
      { name: "꿈비", keywords: ["더블원피스매트","꿈비더블원피스매트","트리플원피스매트","꿈비트리플원피스매트","자이언트매트","꿈비자이언트매트","클린롤매트","리코코클린롤매트","꿈비클린롤매트","꿈비폴더매트","꿈비복도매트","꿈비매트","리코코매트","리코코폴더매트","꿈비원피스매트","꿈비접이식매트"] },
      { name: "알집매트", keywords: ["알집폴더매트","알집더블제로매트","알집트리플제로매트","알집트윈매트","알집더블플립매트","알집에코실리온","알집매트더블제로매트","알집복도제로매트","에코실리온","알집매트커버","알집매트","알집매트더블제로","알집접이식매트"] },
      { name: "크림하우스", keywords: ["크림하우스폴더매트","크림하우스프리2","크림하우스프리2폴더매트","크림하우스프리2s","크림하우스프리2베이비룸","슬라이드프리","크림하우스슬라이드프리","크림하우스슬라이드프리와이드","프리그라운드2","크림하우스프리그라운드2","크림하우스맞춤매트","크림하우스맞춤폴더매트"] },
  ...
  construction_mat_kkumbi: {
    label: "시공매트(꿈비기준)",
    brands: [
      { name: "꿈비", keywords: ["꿈비시공매트","꿈비매트시공","꿈비퍼즐매트","리코코퍼즐매트","꿈비시공퍼즐매트","리코코황변방지","리코코디자인tpu클립매트","꿈비전문가시공","꿈비TPU매트","리코코시공매트","리코코매트시공","꿈비베페","꿈비베이비페어"] },
      { name: "알집매트", keywords: ["알집시공매트","알집거실시공","알집노블시공","알집tpu시공매트","알집tpu매트","알집tpu시공","알집매트시공비용","알집매트시공","알집베페","알집베이비페어"] },
      { name: "크림하우스", keywords: ["크림하우스시공매트","크림하우스시공","크림하우스퍼즐매트","크림하우스셀프시공","크림하우스매트시공","크림하우스매직퍼즐매트","매직퍼즐매트","크림하우스베페","크림하우스베이비페어"] },
      { name: "파크론", keywords: ["파크론시공","파크론매트시공","파크론시공매트","파크론제로블럭","파크론퍼즐매트","파크론셀프시공","파크론tpu","파크론tpu매트","제로블럭"] },
    ],
  },
  construction_mat_bombom: {
    label: "시공매트(봄봄매트기준)",
    brands: [
      { name: "봄봄매트", keywords: ["봄봄매트시공","봄봄시공매트","봄봄스킨텍스처","시공매트봄봄매트","봄봄매트","봄봄TPU매트","봄봄TPU시공매트","봄봄베페","봄봄베이비페어"] },
      { name: "플로리아", keywords: ["플로리아시공매트","플로리아매트시공","플로리아매트","플로리아TPU매트","플로리아매트베페","플로리아매트베이비페어"] },
      { name: "에코폼", keywords: ["에코폼매트","에코폼","에코폼시공매트","에코폼매트시공","맘편한매트","맘편한시공매트"] },
      { name: "허그매트", keywords: ["허그매트","허그매트시공","허그시공매트","허그매트TPU매트","허그매트TPU시공매트","허그매트베페","허그매트베이비페어"] },
      { name: "보들매트", keywords: ["보들매트","보들매트시공","보들시공매트","보들청담매트","보들TPU매트","보들매트베페","보들매트베이비페어"] },
    ],
  },
  bumper_bed: {
    label: "범퍼침대/아기침대",
    brands: [
      { name: "꿈비", keywords: ["꿈비범퍼침대","꿈비아기침대","꿈비하이가드범퍼침대","꿈비범퍼침대대형","꿈비범퍼침대특대형","꿈비범퍼침대슈퍼특대형","꿈비범퍼침대매트","꿈비트윈스타","꿈비월드스타","꿈비럭키스타","꿈비럭키스타범퍼침대","꿈비하이가드"] },
      ...
      { name: "바치", keywords: ["바치조이범퍼침대","바치포칠드런범퍼침대","바치범퍼침대특대형","바치범퍼침대가드","바치범퍼침대매트","바치물결범퍼침대","바치범퍼침대"] },
  ...
  bottle_washer: {
    ...
    brands: [
      ...
      { name: "베이비브레짜", keywords: ["베이비브레짜젖병세척기","브레짜젖병세척기","베이비브레짜젖병세척소독기","브레짜젖병세척소독기","베이비브레짜세척기","브레짜세척기","브레짜젖병소독기"] },
      ...
      { name: "픽셀", keywords: ["픽셀젖병소독기","폴레드젖병소독기","폴레드픽셀","픽셀젖병세척기","폴레드젖병세척기"] },
      { name: "유팡", keywords: ["유팡젖병소독기","유팡픽셀","유팡젖병세척기"] },
    ],
  },
  formula_pot: {
    label: "분유포트",
    brands: [
      { name: "꿈비", keywords: ["꿈비휴대용분유포트","꿈비보온병","꿈비외출용분유포트","꿈비휴대용포트","꿈비분유포트","꿈비무선분유포트","꿈비분리형휴대용분유포트","꿈비분리형분유포트","꿈비배터리분리형분유포트","꿈비배터리분리형포트","꿈비배터리분유포트"] },
  ...
  formula_shaker: {
    ...
    brands: [
      ...
      { name: "폴레드", keywords: ["폴레드분유쉐이커","폴레드쉐이커","폴레드젖병쉐이커","폴레드분유제조기","폴레드분유믹서기","픽셀이지분유쉐이커","픽셀이지쉐이커","픽셀분유쉐이커","픽셀쉐이커"] },
    ],
  },
  organic_ground: {
    label: "오가닉그라운드",
...
// base(현재 저장된 값)에 addition(새 기본값)을 "추가만" 한다 — 기존 데이터는 절대 안 지움
function additiveMergeGroup(base: GroupDef, addition: GroupDef): GroupDef {
  const brandMap = new Map<string, BrandDef>();
  for (const b of base.brands) brandMap.set(b.name, { name: b.name, keywords: [...b.keywords] });
  for (const b of addition.brands) {
    if (brandMap.has(b.name)) {
      const existing = brandMap.get(b.name)!;
      existing.keywords = dedupeArr([...existing.keywords, ...b.keywords]);
    } else {
      brandMap.set(b.name, { name: b.name, keywords: [...b.keywords] });
    }
  }
  return { label: base.label || addition.label, brands: Array.from(brandMap.values()) };
}

// 1회성 마이그레이션: construction_mat을 꿈비기준/봄봄매트기준으로 분리 + 누락 키워드/브랜드 추가
function runMigrationV2(groups: Groups): Groups {
  const result: Groups = { ...groups };

  const oldConstruction = result["construction_mat"];
  if (oldConstruction) {
    const kkumbiNames = ["꿈비", "알집매트", "크림하우스", "파크론"];
    const kkumbiBrands = oldConstruction.brands.filter((b) => kkumbiNames.includes(b.name));
    const bombomBrands = oldConstruction.brands.filter((b) => !kkumbiNames.includes(b.name));
    result["construction_mat_kkumbi"] = additiveMergeGroup(
      { label: "시공매트(꿈비기준)", brands: kkumbiBrands },
      DEFAULT_GROUPS["construction_mat_kkumbi"]
    );
    result["construction_mat_bombom"] = additiveMergeGroup(
      { label: "시공매트(봄봄매트기준)", brands: bombomBrands },
      DEFAULT_GROUPS["construction_mat_bombom"]
    );
    delete result["construction_mat"];
  } else {
    if (!result["construction_mat_kkumbi"]) result["construction_mat_kkumbi"] = DEFAULT_GROUPS["construction_mat_kkumbi"];
    if (!result["construction_mat_bombom"]) result["construction_mat_bombom"] = DEFAULT_GROUPS["construction_mat_bombom"];
  }

  for (const key of Object.keys(DEFAULT_GROUPS)) {
    if (key === "construction_mat_kkumbi" || key === "construction_mat_bombom") continue;
    if (result[key]) {
      result[key] = additiveMergeGroup(result[key], DEFAULT_GROUPS[key]);
    } else {
      result[key] = DEFAULT_GROUPS[key];
    }
  }
...
export async function GET(request: Request) {
  try {
    ...
    if (migrate === "v2") {
      const stored = (await kvGet("keyword_groups")) ?? DEFAULT_GROUPS;
      const migrated = runMigrationV2(stored);
      await kvSet("keyword_groups", migrated);
      return NextResponse.json({ migrated: true, groups: migrated });
    }

    const stored = await kvGet("keyword_groups");
    if (stored) {
      const merged: Groups = { ...DEFAULT_GROUPS };
